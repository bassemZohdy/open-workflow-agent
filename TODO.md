...
- [x] **TEST-3** — increase the core coverage threshold from 80% to 90%. Shipped: expanded deterministic tests across protocol, catalog, storage, knowledge, lifecycle, sandbox, API-boundary, scheduling, tool, and server paths; the full suite reports 90.24% exact core coverage (613/6281 statements missed) and CI now enforces `--cov-fail-under=90`.

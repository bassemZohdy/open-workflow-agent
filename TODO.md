...
1. **P3 — HITL and external catalogs:** specify security, persistence, approval, and capability contracts before implementation; keep external catalogs disabled by default.

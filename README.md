...
The next milestone is **HITL and external catalogs**: specify security, persistence, approval, and capability contracts before implementation; external catalogs remain disabled by default. Optional A2A exposure, streaming, and additional engines remain deferred. The ordered plan is in [TODO.md](TODO.md).
